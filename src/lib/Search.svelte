...
const documentMeta = (strings, searchString) => {
  ...
  }).flat(1).filter(doc => doc.word.toLowerCase() === searchString.toLowerCase())
}
...
<div class="shadow-lg rounded-lg">
  <div class="py-5 px-4 sm:px-6">
    <h3 class="text-lg font-medium text-green-900">Doc Search</h3>
    <p class="mt-1 max-w-2xl text-sm text-gray-500">{directions}</p>
  </div>
