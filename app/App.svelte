...
<main class="mt-32 font-sans ml-3 mr-3">
  ...
  <div class="absolute right-0 w-14 h-40">
    <span class="absolute mx-auto p-2">

      <a class="text-gray inline" title="Fork This?" href="https://github.com/yelsaw/doc-search/fork"><svg>
